...
import { Search, MessageCircle, ThumbsUp, Clock } from "lucide-react"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <Button
                variant="secondary"
                className="flex items-center justify-between p-6 bg-white/5 hover:bg-white/10 text-white"
              >
                <div>
                  <h2 className="text-xl font-semibold mb-1">News and Announcements</h2>
                  <p className="text-sm text-gray-400">Official updates and news</p>
                </div>
                <div className="text-blue-400">&rarr;</div>
              </Button>
              ...
              >
                <div>
                  <h2 className="text-xl font-semibold mb-1">Ask the Community</h2>
                  <p className="text-sm text-gray-400">Get help from others</p>
                </div>
                <div className="text-blue-400">&rarr;</div>
              </Button>
            </div>
